...
**future gate** are not measurements or supported limits: their numeric budgets, if any, require the
named product, format, migration, or operational decision before a later implementation can claim
them.

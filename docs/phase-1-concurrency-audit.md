...
source inspection found no new lock-order inversion in the documented path. Cross-process coordination
is intentionally unsupported and remains Phase 4.
...
| CONC-03 | P2 deferred scope | Independent openers do not share allocator, history, or commit lock. | `docs/status.md` and `docs/design.md` explicitly scope this out. | Reject as a Phase 1 fix; preserve Phase 4 reservation. |

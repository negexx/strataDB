...
| PERF-01 | `bench/`, `docs/phase-1-performance.md` | Cloud before/after workflow | P1 | Full pinned-fixture run 31647664161 in progress; no result claimed yet |
...
| VER-02..04 | `.github/workflows/ci.yml`, docs | CI provenance, cargo deny | P1/P2 | Exact-head GitHub Actions run 31644869407 passed; benchmark provenance pending run 31647664161 |
